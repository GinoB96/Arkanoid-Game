...
public class Bloque extends ElementoGrafico {
    private int dureza; //indica la cantidad de coliciones que resiste el bloque
    private int puntosPorBloque;
    private int color; //1 es Azul,2 es Rosa,3 es Roja,4 es Amarilla
    ...
    public void setNroColor(int nroDelColor){
    ...
    public void setDureza(int durezaDelBloque){
                  switch(durezaDelBloque){
                    ...
                    case 6: this.dureza=18750;break;
